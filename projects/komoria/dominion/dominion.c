    ...
    {                               //Boolean true or going to discard an estate
        ...
        while (card_not_discarded)
        {
            ...
            else if (p > state->handCount[currentPlayer])
            {
                ...
                card_not_discarded = 0; //Exit the loop // bug2 but removing for assignment 4
            }
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        return handleMine(currentPlayer, choice1, choice2, state, handPos);
    ...
    case minion:
        return handleMinion(currentPlayer, choice1, choice2, state, handPos);
    ...
    case tribute:
        return handleTribute(currentPlayer, nextPlayer, state, handPos);

    case ambassador:
        return handleAmbassador(currentPlayer, choice1, choice2, state, handPos); 
